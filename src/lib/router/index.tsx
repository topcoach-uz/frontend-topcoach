...
const SuccessStoriesPageLazy = lazy(() => import('src/pages/success-stories'));
...
const EventDetailsPageLazy = lazy(() => import('src/pages/events/detail'));
const ApplyToEventPageLazy = lazy(
  () => import('src/pages/events/detail/apply')
);
const ApplyToEventGraduagePage = lazy(
...
const MentorDetailsPageLazy = lazy(() => import('src/pages/mentors/details'));
const UniversitiesPageLazy = lazy(() => import('src/pages/universities'));
...
const AuthLayoutLazy = lazy(() => import('src/components/layouts/auth'));
...
const ForgotPageLazy = lazy(() => import('src/pages/auth/forgot-password'));
const VerificationPageLazy = lazy(() => import('src/pages/auth/verification'));
const EmailSentPageLazy = lazy(
  () => import('src/pages/auth/forgot-password/sent')
);
const PrivacyPolicyPageLazy = lazy(() => import('src/pages/privacy-policy'));
        ...
        <Route element={<RootLayout />}>
          ...
          <Route element={<MainLayout />}>
            <Route element={<AddFallbackLayout />}>
              <Route
                index
                element={isAuthenticated ? <HomePage /> : <LandingPageLazy />}
              />
              <Route path="/universities" element={<UniversitiesPageLazy />} />
              <Route
                path="/universities/:id"
                element={<UniversityDetailPageLazy />}
              />
              <Route path="/mentors" element={<MentorsPageLazy />} />
              <Route path="/mentors/:id" element={<MentorDetailsPageLazy />} />
              <Route path="/events" element={<EventsPageLazy />} />
              <Route path="/events/:id" element={<EventDetailsPageLazy />} />
              <Route
                path="/events/undergraduate"
                element={<ApplyToEventPageLazy />}
              />
              <Route
                path="/events/graduate"
                element={<ApplyToEventGraduagePage />}
              />
              <Route
